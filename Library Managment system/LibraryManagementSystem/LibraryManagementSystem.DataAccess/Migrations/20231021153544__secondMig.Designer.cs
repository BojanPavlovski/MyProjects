...
namespace LibraryManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20231021153544__secondMig")]
    partial class _secondMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryManagementSystem.Domain.Domain.RentInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateOfPickUp = new DateTime(2023, 10, 21, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfReturn = new DateTime(2023, 11, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            Price = 50,
                            UserId = 1
                        },
                        new

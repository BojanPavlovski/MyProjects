...
namespace LibraryManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20231009142741__update")]
            ...
            modelBuilder.Entity("LibraryManagementSystem.Domain.Domain.RentInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateOfPickUp = new DateTime(2023, 10, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfReturn = new DateTime(2023, 10, 23, 0, 0, 0, 0, DateTimeKind.Local),
                            Price = 50,
                            UserId = 1
                        },
                        new

...
namespace LibraryManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20230915163034__initial")]
            ...
            modelBuilder.Entity("LibraryManagementSystem.Domain.Domain.RentInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateOfPickUp = new DateTime(2023, 9, 15, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfReturn = new DateTime(2023, 9, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            Price = 50,
                            UserId = 1
                        },
                        new
